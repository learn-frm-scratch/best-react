...
import "./index.css";
import userIcon from "./src/Images/user-image.png";
...
// ])
// creating title for Logo 
const Title = () => {
    <a>
        <img className ="logo" src={userIcon} alt="Logo title"></img>
    </a>
}
        ...
        <div className="header">
            ...
            <div>
                <ul>
                    <li>Home</li>
                    <li>About</li>
                    <input type="text" placeholder="Search for restaurent and food"></input>
                    <li>Contact</li>
                    <li>Shopping Cart</li>
                </ul>
            </div>
...
const Footer = () => {
    return (
        <div className="footer">
            created by React <strong>Food App</strong>
        </div>
    )
}
